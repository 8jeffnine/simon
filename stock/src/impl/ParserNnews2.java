...
public class ParserNnews2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
//		new ParserNnews2().getHtmlData("C://catch_mi//20170319_1.html");
	}
...
//			System.out.println(doc.toString());
		...
		/** Parsing Data Select */
			Elements rows = doc.select("ul.type13 li dl dt"); // title
		...
		/** Data type Select  */
			...
			for(int i=0; i<rows.size(); i++){
				...
				try {
					...
					System.out.println(oid+"\t| "+date+"\t| "+title[i].substring(0, 12)+"\t| "+artiURL[i]);
